def model_5_biLSTM_with_ema_9_macd_history_trend_type(image_shape, days_result, days_of_ema_9=2, days_of_macd_history=2):
    ...
    return model, "model_5_biLSTM_with_ema_9_macd_history_trend_type"
